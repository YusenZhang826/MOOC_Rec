...
class Decoder(nn.Module):
    ...
    def forward(self, dec_inputs, enc_inputs, enc_outputs):
        ...
        # dec_self_attn_mask = dec_self_attn_pad_mask + dec_self_attn_subsequence_mask.cuda()
        # len_k = dec_self_attn_mask.shape[1]
        # for i in range(len_k):
        #     for j in range(len_k):
        #         if dec_self_attn_mask[:, i, j] > 0:
        #             dec_self_attn_mask[:, i, j] = 1
